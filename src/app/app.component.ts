    ...
    <div class="min-h-screen bg-[#050505] text-gray-100 font-sans flex flex-col md:flex-row">
        ...
        <nav class="w-full md:w-24 bg-black border-r border-gray-900 p-4 flex md:flex-col items-center justify-between md:justify-start gap-6 sticky top-0 z-50 h-auto md:h-screen">
            ...
            <div class="flex md:flex-col gap-6 w-full justify-around md:justify-start px-2">
               <a routerLink="/dashboard" routerLinkActive="text-green-400 bg-green-900/10 border-green-500 shadow-[0_0_15px_rgba(34,197,94,0.3)]" class="p-3 rounded-xl text-gray-400 border border-gray-800 hover:text-green-300 hover:border-green-500/50 hover:shadow-[0_0_10px_rgba(34,197,94,0.1)] transition-all duration-300 flex flex-col items-center group">
               ...
               <a routerLink="/sales" routerLinkActive="text-blue-400 bg-blue-900/10 border-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.3)]" class="p-3 rounded-xl text-gray-400 border border-gray-800 hover:text-blue-300 hover:border-blue-500/50 hover:shadow-[0_0_10px_rgba(59,130,246,0.1)] transition-all duration-300 flex flex-col items-center group">
               ...
               <a routerLink="/inventory" routerLinkActive="text-yellow-400 bg-yellow-900/10 border-yellow-500 shadow-[0_0_15px_rgba(234,179,8,0.3)]" class="p-3 rounded-xl text-gray-400 border border-gray-800 hover:text-yellow-300 hover:border-yellow-500/50 hover:shadow-[0_0_10px_rgba(234,179,8,0.1)] transition-all duration-300 flex flex-col items-center group">
               ...
               <a routerLink="/shop" routerLinkActive="text-green-400 bg-green-900/10 border-green-500 shadow-[0_0_15px_rgba(34,197,94,0.3)]" class="p-3 rounded-xl text-gray-400 border border-gray-800 hover:text-green-300 hover:border-green-500/50 hover:shadow-[0_0_10px_rgba(34,197,94,0.1)] transition-all duration-300 flex flex-col items-center group">
                    <lucide-icon name="shopping-cart" class="group-hover:scale-110 transition-transform"></lucide-icon>
                    <span class="text-[9px] mt-1 font-mono uppercase tracking-widest">Tienda</span>
               </a>
            </div>
